...
export default function PixelCard({
  ...
  // Move browser-dependent code into useEffect!
  useEffect(() => {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative isolate grid aspect-[4/5] w-full max-w-xs place-items-center overflow-hidden rounded-[25px] border border-[#27272a] transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none sm:max-w-sm lg:max-w-md ${className}`}
